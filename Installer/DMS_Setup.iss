...
;
;  No installer passkey. The installer places files and creates
;  shortcuts. License activation happens on first app launch:
;  the user pastes the key from the LicenseKey.txt supplied
